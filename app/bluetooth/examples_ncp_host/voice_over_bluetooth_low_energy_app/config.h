...
#define CHAR_AUDIO_DATA_ATTRIBUTE_HANDLER      (26)
#define CHAR_ADC_RESOLUTION_ATTRIBUTE_HANDLER  (29)
#define CHAR_SAMPLE_RATE_ATTRIBUTE_HANDLER     (31)
#define CHAR_FILTER_ENABLE_ATTRIBUTE_HANDLER   (33)
#define CHAR_ENCODING_ENABLE_ATTRIBUTE_HANDLER (35)
#define CHAR_TRANSFER_STATUS_ATTRIBUTE_HANDLER (37)
