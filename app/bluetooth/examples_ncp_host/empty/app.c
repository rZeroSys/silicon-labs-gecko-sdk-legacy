...
void appHandleEvents(struct gecko_cmd_packet *evt)
{
  ...
  switch (BGLIB_MSG_ID(evt->header)) {
    ...
    case gecko_evt_system_awake_id:
      /* Target device has woken up. This needs the target device to be able to go to sleep
       * This is a placeholder as this would need wired connection
       * from the target wakeup pin */
      break;
