...
struct gecko_msg_gatt_server_send_user_write_response_rsp_t* send_write_response(struct gecko_cmd_packet* evt, uint16_t characteristic, uint16_t att_errorcode);
