...
#define APP_BLE_ADV_DEVICE_NAME_MAX_LENGTH             19

#define APP_BLE_ADV_DEVICE_NAME_DEFAULT                "Thunderboard #00000"
#define APP_BLE_ADV_DEVICE_NAME_FORMAT_STRING          "Thunderboard #%05d"
