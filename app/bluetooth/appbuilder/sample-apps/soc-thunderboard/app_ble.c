...
void appBleInit(void)
{
  ...
  gswavrsp = gecko_cmd_gatt_server_write_attribute_value(gattdb_system_id,
                                                         0,
  ...
  gswavrsp = gecko_cmd_gatt_server_write_attribute_value(gattdb_firmware_rev,
                                                         0,
  ...
  gswavrsp = gecko_cmd_gatt_server_write_attribute_value(gattdb_board_rev,
                                                         0,
  ...
  gswavrsp = gecko_cmd_gatt_server_write_attribute_value(gattdb_board_serial,
                                                         0,
