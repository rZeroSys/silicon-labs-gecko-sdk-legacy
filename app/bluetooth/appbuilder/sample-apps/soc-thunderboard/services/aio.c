...
#define AIO_NUMBER_OF_DIGITAL_INPUTS  BSP_NO_OF_BUTTONS // Implementation supports max 4 inputs
#define AIO_NUMBER_OF_DIGITAL_OUTPUTS BSP_NO_OF_LEDS    // Implementation supports max 4 outputs
