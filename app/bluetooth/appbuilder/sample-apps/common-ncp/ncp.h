 ...
 *
 ******************************************************************************/
void handle_user_command(const uint8array* data);
...
/***************************************************************************//**
 * @brief
 *   This function resets the transmit queue.
 *
 ******************************************************************************/
void tx_queue_reset();
...
/***************************************************************************//**
 * @brief
 *   This function returns the available space in TX queue for event messages.
 *
 * @details
 *   This allows application to check before it enqueue an event.
 *
 * @return
 *   Length of available space in TX queue in bytes.
 *
 ******************************************************************************/
